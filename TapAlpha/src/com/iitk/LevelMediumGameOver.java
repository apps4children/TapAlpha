...
public class LevelMediumGameOver extends Activity implements OnClickListener
{
    ...
    {
    	MediaPlayer music = MediaPlayer.create(LevelMediumGameOver.this, R.raw.gameover);
        music.start();
    }
    public void alert()
    {
