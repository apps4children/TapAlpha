...
public class LevelHardScreen1 extends Activity 
{
	...
	public void onCreate(Bundle savedInstanceState) 
	{
	   ...
	   mediaPlayer = MediaPlayer.create(LevelHardScreen1.this, R.raw.hard_english);//play on load
	...
	public String[] randomCharacter()
	{
        ...
        {
	    alpha=new String[]{"A","B","C","D","E","F","G","H","I","J","K","L","M"};
        }
        else 
        alpha=new String[]{"a","b","c","d","e","f","g","h","i","j","k","l","m"};
	...
	{		
	    ...
	    {            
	        ...
	        {
	        	snd.play(verygood);
	            Intent intent = new Intent(LevelHardScreen1.this, LevelHardScreen2.class);
